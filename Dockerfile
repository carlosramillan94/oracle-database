...
COPY ./scripts/$RUN_FILE ./scripts/$START_FILE ./scripts/$CREATE_DB_FILE ./scripts/$CREATE_OBSERVER_FILE ./scripts/$CONFIG_RSP ./scripts/$PWD_FILE ./scripts/$CHECK_DB_FILE ./scripts/$USER_SCRIPTS_FILE ./scripts/$RELINK_BINARY_FILE $ORACLE_BASE/
...
COPY --chown=oracle:dba ./files/$INSTALL_FILE_1 ./scripts/$INSTALL_RSP ./scripts/$INSTALL_DB_BINARIES_FILE $INSTALL_DIR/
